  ...
  >
    ...
    <div class="bg-white p-8 w-full max-w-xl rounded">
      ...
      <div class="flex items-center justify-between mt-4">
        ...
        <div class="flex items-center h-8">
          ...
          <div v-show="isSearch" class="relative">
            ...
            <button
              @click="closeSearch()"
              class="absolute right-1.5 top-2 text-gray-400 hover:text-gray-700"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-4 w-4"
      ...
      <div class="mt-5 space-y-1">
        ...
        >
          ...
          <button
            ...
            class="text-red-500 ml-auto group-hover:block hidden hover:text-red-600"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
      ...
      <div class="mt-4">
        <button
          @click="clearAll()"
          class="px-6 py-1.5 text-white bg-indigo-500 hover:bg-indigo-600 rounded text-sm"
        >
          Clear all
        </button>
      </div>
